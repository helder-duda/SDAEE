...
const bancoDeExercicios = {
    "normal": [
        {
            "id": 1,
            "tipo": "Normal (RLC)",
            "enunciado": "Um circuito RLC série operando em $f = 60\\text{ Hz}$ é alimentado por uma fonte de tensão de $V_s = 220\\angle{0^\\circ}\\text{ V}$. Os componentes do circuito são $R = 15\\ \\Omega$, um indutor de $L = 79{,}58\\text{ mH}$ e um capacitor de $C = 265{,}26\\ \\mu\\text{F}$. Calcule a impedância total do circuito ($Z_{eq}$) e a corrente total da fonte ($I_s$).",
        ...
        },
        {
            "id": 2,
            "tipo": "Normal (RC)",
            "enunciado": "Um resistor de $R = 12\\ \\Omega$ está em paralelo com um capacitor de $C = 165{,}79\\ \\mu\\text{F}$ em uma rede de $f = 60\\text{ Hz}$. O circuito é alimentado por uma fonte de tensão de $V_s = 48\\angle{30^\\circ}\\text{ V}$. Determine a corrente em cada ramo ($I_R$, $I_C$) e a corrente total ($I_s$).",
        ...
        },
        {
            "id": 3,
            "tipo": "Normal (RL)",
            "enunciado": "Um circuito RL série operando em $f = 60\\text{ Hz}$ possui uma fonte de tensão de $V_s = 100\\angle{0^\\circ}\\text{ V}$, um resistor de $R = 3\\ \\Omega$ e um indutor de $L = 10{,}61\\text{ mH}$. Encontre a impedância equivalente total ($Z_{eq}$) do circuito e determine a intensidade da corrente total ($I_s$).",
        ...
        },
        {
            "id": 4,
            "tipo": "Normal (RC)",
            "enunciado": "Considere um circuito RC série alimentado por $V_s = 120\\angle{-10^\\circ}\\text{ V}$ em $f = 60\\text{ Hz}$. Sendo $R = 8\\ \\Omega$ e $C = 442{,}03\\ \\mu\\text{F}$, determine a impedância equivalente em formato polar ($Z_{eq}$) e a corrente drenada pelo circuito ($I_s$).",
        ...
        },
        {
            "id": 5,
            "tipo": "Normal (RL)",
            "enunciado": "Um circuito composto por um resistor de $R = 30\\ \\Omega$ em paralelo com um indutor de $L = 106{,}10\\text{ mH}$ é ligado a uma fonte de $V_s = 60\\angle{0^\\circ}\\text{ V}$ operando em $f = 60\\text{ Hz}$. Calcule os fasores da corrente no resistor ($I_R$), no indutor ($I_L$) e a corrente global de entrada ($I_s$).",
        ...
        },
        {
            "id": 6,
            "tipo": "Normal (RLC)",
            "enunciado": "Um circuito RLC série em $f = 60\\text{ Hz}$ possui componentes com $R = 40\\ \\Omega$, $L = 132{,}63\\text{ mH}$ e $C = 132{,}63\\ \\mu\\text{F}$. Sabendo que o circuito está conectado a uma fonte de $V_s = 200\\angle{45^\\circ}\\text{ V}$, calcule a impedância equivalente ($Z_{eq}$) e o fasor de corrente ($I_s$).",
        ...
        },
        {
            "id": 7,
            "tipo": "Normal (RLC)",
            "enunciado": "Uma fonte senoidal de $V_s = 100\\angle{0^\\circ}\\text{ V}$ operando em $f = 60\\text{ Hz}$ alimenta um circuito RLC paralelo com parâmetros $R = 20\\ \\Omega$, $L = 26{,}53\\text{ mH}$ e $C = 106{,}10\\ \\mu\\text{F}$. Determine a corrente de entrada total ($I_s$) fornecida pela fonte de tensão.",
            "resposta": "**Forma Polar:** $I_s = 7{,}81\\angle{-50{,}19^\\circ}\\text{ A}$\n**Forma Retangular:** $I_s = (5 - j6)\\text{ A}$"
        },
        {
            "id": 8,
            "tipo": "Normal (RL)",
            "enunciado": "Uma bobina real em uma rede de $f = 60\\text{ Hz}$ é representada por um circuito série contendo resistência interna $R = 12\\ \\Omega$ e indutância $L = 13{,}26\\text{ mH}$. Se alimentada por uma fonte $V_s = 50\\angle{60^\\circ}\\text{ V}$, quais serão os fasores de impedância total ($Z_{eq}$) e corrente total ($I_s$)?",
        ...
        },
        {
            "id": 9,
            "tipo": "Normal (RC)",
            "enunciado": "Um circuito RC série operando em $f = 60\\text{ Hz}$ com $R = 12\\ \\Omega$ e $C = 530{,}52\\ \\mu\\text{F}$ é energizado por uma tensão alternada de $V_s = 110\\angle{0^\\circ}\\text{ V}$. Descubra os valores fasoriais correspondentes à impedância equivalente ($Z_{eq}$) e à corrente total do circuito ($I_s$).",
        ...
        },
        {
            "id": 10,
            "tipo": "Normal (RLC)",
            "enunciado": "Determine a corrente fasorial total ($I_s$) e a impedância de malha ($Z_{eq}$) em $f = 60\\text{ Hz}$ para um circuito RLC série alimentado por $V_s = 10\\angle{-20^\\circ}\\text{ V}$ cujos parâmetros são $R = 6\\ \\Omega$, $L = 39{,}79\\text{ mH}$ e $C = 378{,}94\\ \\mu\\text{F}$.",
    ...
    "engenharia_reversa": [
        ...
        },
        {
            ...
            "enunciado": "Em um circuito paralelo RL em $f = 60\\text{ Hz}$ com $R = 20\\ \\Omega$ e $L = 39{,}79\\text{ mH}$, a corrente medida localmente no ramo do indutor é de $I_L = 8\\angle{-30^\\circ}\\text{ A}$. Realize a engenharia reversa para determinar a tensão nos terminais do circuito ($V_s$) e a corrente total gerada pela fonte de alimentação ($I_s$).",
        ...
        },
        {
            ...
            "enunciado": "Consulte um circuito misto operando em $f = 60\\text{ Hz}$ onde uma fonte de tensão desconhecida alimenta um resistor $R_1 = 5\\ \\Omega$ em série com um paralelo composto por um capacitor de $C = 265{,}26\\ \\mu\\text{F}$ e um indutor de $L = 26{,}53\\text{ mH}$. Sabendo que a corrente medida no capacitor é de $I_C = 4\\angle{90^\\circ}\\text{ A}$, determine a corrente de entrada ($I_s$) e a tensão total da fonte ($V_s$).",
        ...
        },
        {
            "id": 14,
            "tipo": "Engenharia Reversa (RL)",
            "enunciado": "A partir de um circuito RL série desconhecido em $f = 60\\text{ Hz}$ com $R = 8\\ \\Omega$ e $L = 15{,}92\\text{ mH}$, mediu-se sobre o resistor uma queda de tensão local de $V_R = 16\\angle{20^\\circ}\\text{ V}$. Por meio de engenharia reversa, deduza a corrente total da malha ($I_s$) e a tensão aplicada pela fonte de alimentação ($V_s$).",
        ...
        },
        {
            ...
            "enunciado": "No diagnóstico de um circuito RC série em $f = 60\\text{ Hz}$ onde $R = 15\\ \\Omega$ e $C = 132{,}63\\ \\mu\\text{F}$, obteve-se um registro de corrente no capacitor de $I_C = 4\\angle{30^\\circ}\\text{ A}$. Descubra os parâmetros físicos de excitação total do circuito: a corrente da fonte ($I_s$) e a tensão da fonte ($V_s$).",
        ...
        },
        {
            ...
            "enunciado": "Em um circuito paralelo RC operando em $f = 60\\text{ Hz}$ composto por $R = 10\\ \\Omega$ e $C = 265{,}26\\ \\mu\\text{F}$, o instrumento de teste acusa uma corrente local no resistor de $I_R = 5\\angle{45^\\circ}\\text{ A}$. Calcule fasorialmente a tensão da fonte de alimentação global ($V_s$) e a corrente total consumida pelo circuito ($I_s$).",
        ...
        },
        {
            "id": 17,
            "tipo": "Engenharia Reversa (RL)",
            "enunciado": "Em uma malha série RL em $f = 60\\text{ Hz}$ composta por $R = 50\\ \\Omega$ e $L = 318{,}31\\text{ mH}$, uma ponta de prova acusa que a tensão desenvolvida especificamente nos terminais do indutor vale $V_L = 240\\angle{120^\\circ}\\text{ V}$. Calcule por engenharia reversa a corrente total do circuito ($I_s$) e a tensão fornecida pela fonte principal ($V_s$).",
        ...
        },
        {
            "id": 18,
            "tipo": "Normal Engenharia Reversa (RLC)",
            "enunciado": "Um circuito série em $f = 60\\text{ Hz}$ com parâmetros $R = 4\\ \\Omega$, $L = 31{,}83\\text{ mH}$ e $C = 294{,}73\\ \\mu\\text{F}$ é alimentado por uma fonte desconhecida. Um multímetro de bancada afere que a tensão de queda no resistor é $V_R = 12\\angle{-15^\\circ}\\text{ V}$. Encontre a corrente total ($I_s$) e a tensão fasorial da fonte de alimentação ($V_s$).",
        ...
        },
        {
            "id": 19,
            "tipo": "Normal Engenharia Reversa (RLC)",
            "enunciado": "Um circuito paralelo em $f = 60\\text{ Hz}$ possui ramos com $R = 30\\ \\Omega$, $L = 39{,}79\\text{ mH}$ e $C = 176{,}84\\ \\mu\\text{F}$. A medição da corrente sobre o indutor revelou o valor $I_L = 10\\angle{-45^\\circ}\\text{ A}$. Determine, empregando conceitos de circuitos ressonantes, a tensão do barramento ($V_s$) e a corrente fornecida pela fonte principal ($I_s$).",
        ...
        },
        {
            ...
            "enunciado": "Um circuito em $f = 60\\text{ Hz}$ possui uma carga indutiva equivalente a $Z_L = 50\\angle{36{,}87^\\circ}\\ \\Omega$ conectada em paralelo com um capacitor de $C = 53{,}05\\ \\mu\\text{F}$ ($Z_C = 50\\angle{-90^\\circ}\\ \\Omega$). A corrente de ramo medida na carga indutiva é $I_{Z} = 2\\angle{0^\\circ}\\text{ A}$. Faça a engenharia reversa para encontrar a tensão de nó ($V_s$) e o fasor de corrente total ($I_s$).",
...
function gerarFolhaDeExercicios(container, quantidade, tipoFiltro) {
    ...
    selecionados.forEach((exercicio, index) => {
        ...
        card.innerHTML = `
            ...
            <div>
                <button onclick="toggleResposta(this)" style="padding: 5px 10px; cursor: pointer; border: 1px solid #7f8c8d; background: transparent; border-radius: 4px; color: #333;">Mostrar Gabarito</button>
                <div style="display: none; margin-top: 10px; padding: 10px; background-color: #e8f8f5; color: #27ae60; border: 1px solid #2ecc71; border-radius: 4px; line-height: 1.6;">
                    <strong>Gabarito Oficial:</strong><br>${exercicio.resposta.replace(/\n/g, '<br>')}
                </div>
            </div>
        `;
